import type { CanonicalReservation, ChannelProvider } from "./reservation";
import { channelFor } from "./channel-util";
...
export function reservationsFromIcal(text: string, provider: ChannelProvider): CanonicalReservation[] {
